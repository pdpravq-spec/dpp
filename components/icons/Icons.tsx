...
export const MagicIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m9.75 3.104 5.25 5.25m0 0-5.25 5.25M15 8.354 9.75 13.604m0-5.25L15 3.104m-5.25 5.25L3.356 2.146a.75.75 0 0 0-1.06 1.06l4.25 4.25a.75.75 0 0 0 1.06 0l4.25-4.25a.75.75 0 0 0-1.06-1.06L9.75 8.354Zm0 5.25-1.5-1.5-4.5 4.5 1.5 1.5 4.5-4.5-1.5-1.5Zm9.75-6.525-4.5 4.5 1.5 1.5 4.5-4.5-1.5-1.5Z" />
  </svg>
);

export const WandIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-2.26-1.286 2.988 2.988 0 0 0-2.63 2.631 3 3 0 0 0 2.26 1.286 2.988 2.988 0 0 0 2.63-2.631ZM18.75 9.188a3 3 0 0 0-2.26-1.286 2.988 2.988 0 0 0-2.63 2.631 3 3 0 0 0 2.26 1.286 2.988 2.988 0 0 0 2.63-2.631ZM16.5 3.375a3 3 0 0 0-2.26-1.286 2.988 2.988 0 0 0-2.63 2.631 3 3 0 0 0 2.26 1.286 2.988 2.988 0 0 0 2.63-2.631Z" />
    </svg>
);
